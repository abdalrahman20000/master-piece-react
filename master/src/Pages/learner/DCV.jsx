...
function DCV() {
    ...
    return (
        <main className='p-5 max-sm:p-0  flex justify-center items-center'>
            ...
            <div className="bg-blue-800 text-white p-4 space-y-4 w-[60%] max-sm:w-full max-md:w-full max-lg:w-full">
                ...
                <div className="bg-blue-200 p-2 rounded flex justify-between items-center">
                    <span className="text-blue-800">Mentor name .....</span>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {[1, 2, 3, 4, 5, 6].map((_, index) => (
                            <div key={index} className="bg-blue-700 p-2 rounded flex justify-between items-center">
                                <span>Topic .....</span>
                                <Check className="text-green-500" />
                            </div>
                        ))}
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {[1, 2, 3, 4, 5, 6].map((_, index) => (
                            <div key={index} className="bg-blue-300 text-blue-800 p-2 rounded flex justify-between items-center">
                                <span>Mentor .....</span>
                                <Check className="text-green-500" />
                            </div>
                        ))}
                ...
                <div className="flex justify-between items-center">
                    ...
                    <button className="bg-blue-300 text-blue-800 px-4 py-2 rounded flex items-center">
