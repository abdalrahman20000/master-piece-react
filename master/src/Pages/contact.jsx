    ...
    <div className="bg-gray-100 min-h-screen flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
        ...
        <div className="flex justify-center space-x-4 mb-6 max-sm:flex-wrap ">
          <button className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded flex items-center max-sm:m-2 max-sm:w-[40%]">
            <Mail className="mr-2" size={18} />
            Email
          </button>
          <button className="bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded flex items-center max-sm:m-2 max-sm:w-[40%]">
