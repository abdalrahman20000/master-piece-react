            ...
            <div className="max-w-7xl mx-auto space-y-4">
                ...
                {/* <div className="relative">
                    <input
                        ...
                        className="w-full bg-blue-800 p-3 rounded-lg pl-10"
                    />
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    {/* Alerts Column */}
                    <div className="md:col-span-2 bg-blue-800 p-4 rounded-lg">
                        <h2 className="font-bold mb-2">Alerts</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            {Array(6).fill().map((_, i) => (
                                <div key={i} className="bg-blue-700 p-2 rounded">Alert {i + 1}</div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="bg-blue-800 p-4 rounded-lg flex items-center space-x-4">
                            <User size={48} />
                            <div>
                                <div>Mentor name</div>
                                <div className="text-sm text-blue-300">Professional title</div>
                            </div>
                        </div>
                        <div className="bg-blue-800 p-4 rounded-lg grid grid-cols-2 gap-2">
                ...
                <div className="bg-blue-800 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                        {Array(8).fill().map((_, i) => (
                            <div key={i} className="bg-blue-700 p-2 rounded flex justify-between items-center">
                                <span>Topic {i + 1}</span>
                                {/* <ChevronDown size={16} /> */}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
                        {Array(5).fill().map((_, i) => (
                            <div key={i} className="bg-blue-700 p-2 rounded">
                                ...
                                <input type="text" className="w-full bg-blue-600 mt-1 p-1 rounded" placeholder="Assignment details" />
                                <button className="w-full bg-blue-500 mt-1 p-1 rounded">Submit</button>
                            </div>
                        ))}
                    </div>
                </div>
